...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-full bg-[#020617] flex flex-col items-center justify-center px-6 relative overflow-hidden">
      {/* Background effects */}
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="space-y-3 mb-6">
          <button 
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl border border-slate-800 bg-[#0c1222] text-sm font-medium text-slate-200 hover:bg-slate-800/80 hover:border-slate-700 transition-all"
          >
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <label className="flex items-center gap-2 cursor-pointer">
              <input type="checkbox" className="w-4 h-4 rounded border-slate-700 bg-[#0c1222] text-purple-500 focus:ring-purple-500/20" />
              <span className="text-xs text-slate-400">Remember me</span>
            </label>
            <Link href="#" className="text-xs text-purple-400 hover:text-purple-300 transition-colors font-medium">
              Forgot password?
            </Link>
          </div>
